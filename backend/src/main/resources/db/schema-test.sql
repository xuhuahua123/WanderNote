-- WanderNote Backend Database Schema (Test Environment)
-- Version: 0.1.0
-- Date: 2026-05-29
-- Environment: Test/Dev

-- 创建测试数据库
CREATE DATABASE IF NOT EXISTS wandernote_test DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
